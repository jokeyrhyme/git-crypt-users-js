...
async function addUser(
  { cwd = process.cwd(), userId } /* : AddUserOptions */ = {}
) {
  await execa(
    'git',
...
async function backupEncryptedFiles(
  { cwd = process.cwd() } /* : BackupEncryptedFilesOptions */ = {}
) {
...
async function getStatus(
  { cwd = process.cwd() } /* : GetStatusOptions */ = {}
) {
...
async function getUserIds(
  { cwd = process.cwd() } /* : GetUserIdsOptions */ = {}
) {
...
async function installHooks(
  { cwd = process.cwd() } /* : InstallHooksOptions */ = {}
) {
...
async function removeHooks(
  { cwd = process.cwd() } /* : RemoveHooksOptions */ = {}
) {
...
async function rotateKey(
  { cwd = process.cwd() } /* : RotateKeyOptions */ = {}
) {
  let backupDir;
