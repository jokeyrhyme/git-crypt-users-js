...
*/ async function listLocalConfigKeys(
  { cwd = process.cwd() } /* : ListLocalConfigKeysOptions */ = {}
) {
...
async function setLocalConfig(
  { cwd = process.cwd(), key, value } /* : SetLocalConfigOptions */ = {}
) {
  const flags = ['--local'];
...
async function stage(
  { cwd = process.cwd(), filePath } /* : StageOptions */ = {}
) {
...
async function unsetLocalConfig(
  { cwd = process.cwd(), key } /* : UnsetLocalConfigOptions */ = {}
) {
